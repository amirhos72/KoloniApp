...
const AppContent: React.FC = () => {
  return (
    <div className="min-h-screen font-sans max-w-md mx-auto relative shadow-2xl overflow-hidden transition-colors duration-500 bg-[#f0f2f5] dark:bg-black bg-[radial-gradient(circle_at_50%_0%,#ffffff_0%,#eef2f6_70%)] dark:bg-[radial-gradient(circle_at_50%_0%,#1f1c10_0%,#000000_70%)]">
